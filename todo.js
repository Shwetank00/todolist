document.addEventListener("DOMContentLoaded", function () {
    ...
    <button class="remove-btn" onclick="removeTask(this)">Remove</button>`;
      ...
      for (let i = 0; i < existingTasks.length; i++) {
        ...
        if (
          newTask.deadline < existingDeadline ||
          (newTask.deadline === existingDeadline &&
            newTask.priority < existingPriority)
        ) {
    ...
    function editTask(button) {
      ...
      // Remove the existing "Edit" and "Remove" buttons
      const existingEditButton = li.querySelector(".edit-btn");
      ...
      const newPriorityInput = createPriorityDropdown(
        priorityElement.textContent.replace("Priority:", "").trim()
      );
      ...
      // Store the "Edit" button in the higher scope variable
